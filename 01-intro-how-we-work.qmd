...
We are marine microbiologists with a particular interest in microbial community dynamics in ocean ecosystems. We strive for a holistic approach to answering scientific questions through collaborations with microbiologists, ecologists, engineers and physical oceanographers. We have spent the last 8 years focusing on the Southern Benguela Upwelling region, with a specific focus on how the resident microbial community is affecting critical nutrient cycling here. We conduct our work using Open Data Science principles, emphasizing scientific excellence (not perfection) that is transparent, reproducible, collaborative, and ethical. We aim to make our methods and results available and support ongoing learning.\
...
Currently, we meet in person for weekly lab meetings, and individual meetings with Emma.\
We use Googledocs or MS Teams to set agendas, record decisions made, and outline action items during meetings. Each lab member has their own google doc for their 1:1 meetings with Emma. Prior to each meeting, create your agenda for that meeting there.
...
## How we share things (and send them to Emma)
...
We maintain a lab SM Teams folder for lab publications, presentations, photos, CVs, etc. Please make use of these so that others in the lab can make fair use of our work.

## Shared lab resources

Where to find shared resources: - Google Drive - You will be given access to the shared drive during onboarding, take a look at the Lab Meetings folder to find Lab Meeting Notes for each semester  - GitHub - theMMElab is the shared GitHub account for the lab - lab-manual - This repository contains the lab manual.
